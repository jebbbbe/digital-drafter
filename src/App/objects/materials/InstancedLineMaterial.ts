    ...
    constructor(parameters: MatrixTextureLineMaterialParameters = {}) {
        super({
            ...
            uniforms: UniformsUtils.clone(
                ShaderLib["instanceLineWeight"].uniforms
            ),
            vertexShader: ShaderLib["instanceLineWeight"].vertexShader,
            fragmentShader: ShaderLib["instanceLineWeight"].fragmentShader,
